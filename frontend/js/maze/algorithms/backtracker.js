...
/**
 * This generator function performs returns an iterator for the backtracker
 * algorithm. It yields room tiles and passage tiles in the order they should be
 * revealed. Random choices use `rng` so that replaying with the same `seed`
